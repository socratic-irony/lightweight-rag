...
def create_parser() -> argparse.ArgumentParser:
    ...
    # RM3
    parser.add_argument(
        "--rm3", action="store_true", help="Enable RM3 pseudo-relevance feedback query expansion"
    )
    ...
    # Proximity & n-grams
    parser.add_argument(
        "--no_prox", action="store_true", help="Disable proximity bonus (enabled by default)"
    )
    ...
    parser.add_argument(
        "--semantic_topn", type=int, help="Number of top candidates to rerank semantically"
    )
